...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <fieldset>
                    <legend><font size="5"> Vacant Room List </font></legend>
                    <h5 align="center"><B><?php echo 'HALL  '.strtoupper($hallName)?></B></h5>
                    <?php

                    $vacant_room_list="SELECT room_no, room_type,room_cost,room_status FROM hall_room NATURAL JOIN room WHERE hall_id='".$hallId."' AND (room_status='Vacant' or room_status='Half-Vacant') ";
                    $count=0;
                    if ($is_query_run=mysqli_query($conn,$vacant_room_list)) {

                        echo "<br>";
                        echo '<table cellpadding="0" cellspacing="0" class="db-table">';
                        echo '<th>Index No</th><th>Room No</th><th>Room Type</th><th>Room Cost</th><th>Room Status</th>';
                         while ($row = mysqli_fetch_array($is_query_run, MYSQL_ASSOC)) {
