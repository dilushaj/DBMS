    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <h5 align="center"><B><?php echo 'ROOM : '.strtoupper($room_no)?></B></h5>
                <?php

                $count=0;

                $stu_room="SELECT * FROM student WHERE room_no='".$room_no."'ORDER BY stu_id";
                if ($is_query_run=mysqli_query($conn,$stu_room)) {
                    echo "<br>";
                    echo '<table cellpadding="0" cellspacing="0" class="db-table">';
                    echo '<th>Index No</th><th>Student ID</th><th>Student Name</th><th>Email</th><th>Department</th><th>Year</th>';
                    while ($row = mysqli_fetch_array($is_query_run, MYSQL_ASSOC)) {
