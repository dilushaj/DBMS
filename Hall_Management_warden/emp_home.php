...
<head>
    <title> Employee_manager_home </title>
    <link rel="stylesheet" type="text/css" href="../Hall_Management_warden/css/css/table.css">
    <link rel="icon" type="image/png" href="../Hall_Management_warden/css/img/favicon.ico">
    ...
    <!-- Bootstrap core CSS     -->
    <link href="../Hall_Management_warden/css/css/bootstrap.min.css" rel="stylesheet"/>

    <!-- Animation library for notifications   -->
    <link href="../Hall_Management_warden/css/css/animate.min.css" rel="stylesheet"/>

    <!--  Light Bootstrap Table core CSS    -->
    <link href="../Hall_Management_warden/css/css/light-bootstrap-dashboard.css" rel="stylesheet"/>

    <!--  CSS for Demo Purpose, don't include it in your project     -->
    <link href="../Hall_Management_warden/css/css/demo.css" rel="stylesheet"/>
...
<div class="wrapper">
    <div class="sidebar" data-color="green" >
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                <li class = "Active">
                    <a href="../Hall_Management/emp_home.php">
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
					...
					<li>
                            <a href="../Hall_Management/change_password_emp.php">
                                Change Password
                            </a>
                        </li>
                        <li>
