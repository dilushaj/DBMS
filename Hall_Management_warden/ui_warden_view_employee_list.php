...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                <fieldset>
                    <legend><font size="5"> Registered Employee List</font></legend>
                    <h5 align="center"><B><?php echo 'HALL  '.strtoupper($hallName)?></B></h5>

                    <?php
                    $count=0;

                    $emp_list="SELECT * FROM employee  WHERE emp_hall IN (SELECT hall_id FROM warden_hall NATURAL JOIN  hall WHERE warden_id='".$id."')";
                    if ($is_query_run=mysqli_query($conn,$emp_list)) {
                        echo "<br>";
                        echo '<table cellpadding="0" cellspacing="0" class="db-table">';
                        echo '<th>Index No</th><th>Employee ID</th><th>Employee Name</th><th>Position</th>';
                        while ($row = mysqli_fetch_array($is_query_run, MYSQL_ASSOC)) {
