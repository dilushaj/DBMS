...
<body>
<font size='5'>Modify Room Details</font><br>
<font size ="4"><p> Enter Room number to modify its information </p></font> <br> 
<form action="modifyRoomEntry.php" method="POST">
Room number <input type ="text" name ="room_no" id ="room_no"> 
