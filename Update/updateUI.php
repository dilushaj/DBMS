...
<body>
<font size='5'>Modify Student Entry</font><br>
<font size ="4"><p> Enter student ID to modify the entry </p></font> <br> 
<form action="modifyStudentEntry.php" method="POST">
Student ID <input type ="text" name ="stu_id" id ="stu_id"> 
