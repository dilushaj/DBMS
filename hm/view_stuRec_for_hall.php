...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
			<legend><font size="5">View Registered Students</font></legend>
  <form action='acmd_stu_rec.php' method="POST">
...
<?php endforeach; ?>	
	   ...
	   <button type="submit" name="view"  value="view" > View Record</button>
      </form>
            </div>
        </div>
