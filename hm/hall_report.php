...
<?php include "dbCon.php";
	...
	$sql = "SELECT  hall_id, hall_name, hall_capacity,hall_type from Hall";
	...
	if($is_query_run= mysql_query($sql,$conn)){
    	...
    	echo "<br>";
				...
				echo '<th>Index No</th><th>Hall Id</th><th>Hall Name</th><th>Hall Capacity</th><th>Hall Type</th>';
		...
		while($row = mysql_fetch_array($is_query_run,MYSQL_ASSOC)){
         	...
         	echo '<tr>';
	   	 	echo '<td>'.++$count.'</td><td>'.$row['hall_id'].'</td><td>'.$row['hall_name'].'</td><td>'.$row['hall_capacity'].'</td><td>'.$row['hall_type'].'</td>';
			echo '</tr>';
