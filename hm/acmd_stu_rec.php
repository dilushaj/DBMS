...
<div class="wrapper">
    <div class="sidebar" data-color="green" >
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                <li>
                    <a href="../Hall_Management_warden/acc_home.php.php">
...
<div class="content">
            <div class="container-fluid">
                <fieldset>
                    <legend><font size="5"> Student Detail Report </font></legend>
                    <br>	
...
if(isset($_POST['view'])){
	...
	$sql = "SELECT stu_id,first_name,last_name,room_no,email  FROM student  WHERE room_no in (SELECT room_no from hall_room NATURAL JOIN hall WHERE hall_name = '".$hall_name."')";
	...
	if($is_query_run= mysql_query($sql,$conn)){
		echo "<br>";
				...
				echo '<th>Index No</th><th>Student Id</th><th>First Name</th><th>Last Name</th><th>Room No</th><th>Email</th>';
		...
		while($row = mysql_fetch_array($is_query_run,MYSQL_ASSOC)){
         	...
         	echo '<tr>';
	   	 	echo '<td>'.++$count.'</td><td>'.$row['stu_id'].'</td><td>'.$row['first_name'].'</td><td>'.$row['last_name'].'</td><td>'.$row['room_no'].'</td><td>'.$row['email'].'</td>';
			echo '</tr>';
