...
<div class="wrapper">
  ...
  <fieldset>
    <legend> <font size="5">Hall information:</font></legend>
	<label> Hall ID: </label> <input type="text" name="id" ><br><br>
    <label> Hall name: </label> <input name= "hallName" type='text' required> </input> <br> <br>
    <label> Hall Capacity: </label> <input name= "hallCapacity" type='text' required ></input> <br><br>
	<label> Hall type:	 </label> <select  name="type">   
